...
Type=simple
User=www-data
ExecStart=/usr/bin/aria2c --console-log-level=warn --conf-path=/etc/aria2/aria2.conf
...
- [Ref1:Ubuntu16 下载软件Aria2 全局配置方法](https://www.jianshu.com/p/b2649d073741)
- [Ref2:ngosang/trackerslist](https://github.com/ngosang/trackerslist)
- [Ref3:Aria2 bt-tracker跟踪服务器列表自动更新](https://www.feng.ee/aria2-trackers-auto-update.html)